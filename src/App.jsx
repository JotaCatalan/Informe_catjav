		...
		<div className="min-h-screen bg-slate-50 flex flex-col">
			...
			<main className="flex-1 max-w-4xl mx-auto px-6 py-12">
				<div className="bg-white rounded-lg shadow p-8">
					...
					<p className="text-slate-600 leading-relaxed">
						Este sitio contiene el análisis legal del caso WannaCry del año 2017, que causo muchos estragos a nivel global.
			...
			<footer className="bg-slate-100 text-slate-600 text-sm py-4 px-6">
				<div className="max-w-4xl mx-auto flex justify-between">
					<span>Estudiante: [Javier Felipe Catalán Marchese]</span>
